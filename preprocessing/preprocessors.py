...
def calcualte_price(df):
    ...
    """
    data = df.copy()
    data = data[['datadate', 'tic', 'prccd', 'ajexdi', 'prcod', 'prchd', 'prcld', 'cshtrd', 'excaus']]
    ...
    data['excaus'] = data['excaus']

    data = data[['datadate', 'tic', 'adjcp', 'open', 'high', 'low', 'volume', 'excaus']]
...
def merge_csv():
    to_merge = ['../data/amzn.csv', '../data/canada-currency-rate.csv']
    ...
    # write it out
    merged.to_csv("../data/merged.csv", header=None, index=None)
